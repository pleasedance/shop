                ...
                <div class="col-md-12">
                    <div class="portlet light">
                        <div class="portlet-body form">
                            <form class="form-horizontal ajax-form" action="/selleradmin/categoryskuproperties/<?php echo $propertie_id; ?>/<?php echo isset($model) ? $model->sp_id : ""; ?>" method="<?php echo isset($model) ? "put" : "post"; ?>">
                                <div class="form-body">
...
<script>
    jQuery(document).ready(function () {
        $('body').on("success", ".ajax-form", function (result) {
            location.href = "/selleradmin/categoryskupropertieslog/<?php echo $propertie_id; ?>";
        });
