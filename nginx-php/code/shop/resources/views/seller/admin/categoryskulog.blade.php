                        ...
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row dataTables_wrapper">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <a href="/selleradmin/categorysku/<?php echo $category_id;?>">
                                            ...
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <?php foreach ($list as $value) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-circle" href="/selleradmin/categorysku/<?php echo $category_id; ?>/<?php echo $value->sku_number; ?>">
                                                                编辑
                                                            </a>
                                                            <a class="btn btn-circle" href="/selleradmin/categoryskupropertieslog/<?php echo $value->sku_number; ?>">
                                                                分类sku值列表
                                                            </a>
