    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <h1 class="page-title"> 商品管理
                <small><?php echo isset($model) ? "修改" : "添加"; ?>商品参数属性</small>
            </h1>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    <li>
                        <i class="icon-home"></i>
                        <a href="/selleradmin">商品管理</a>
                ...
                <div class="col-md-12">
                    <div class="portlet light">
                        <div class="portlet-body form">
                            <form class="form-horizontal ajax-form" action="/selleradmin/productparampro/<?php echo $param_number; ?>/<?php echo isset($model) ? $model->cpp_id : ""; ?>" method="<?php echo isset($model) ? "put" : "post"; ?>">
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="param_propertie_value" value="<?php echo isset($model) ? $model->param_propertie_value : ""; ?>" class="form-control input-inline input-medium">
                                        </div>
                                    </div>
...
<script>
    jQuery(document).ready(function () {
        $('body').on("success", ".ajax-form", function (result) {
            location.href = "/selleradmin/productparampros/<?php echo $param_number; ?>";
        });
