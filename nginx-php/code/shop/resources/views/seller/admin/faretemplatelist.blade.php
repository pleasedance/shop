        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="/selleradmin/faretemplatelist/">运费模板列表</a>
                        <!--                        <i class="fa fa-angle-right"></i>-->
                    </li>
                    <li>
                    ...
                    <div class="portlet light portlet-fit ">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase">运费模板列表</span>
                            </div>
                        </div>
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row dataTables_wrapper">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <a href="/selleradmin/faretemplate">
                                            ...
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <?php foreach ($list as $value) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-circle" href="/selleradmin/faretemplate/<?php echo $value->tpl_id; ?>">
                                                                编辑
                                                            </a>
                                                            <a class="btn btn-circle" href="javascript:;" onclick="statusChange(<?php echo $value->tpl_id.','.($value->status?"0":"1");?>)">
                                                                <?php echo $value->status?"禁用":"启用"; ?>
                                                            </a>
                                                            <a class="btn btn-circle" href="javascript:;" onclick="del(<?php echo $value->tpl_id;?>)">
                                                                删除
                                                            </a>
                                                        </td>
                                                    </tr>
