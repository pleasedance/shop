...
<div class="page-container">
    <!-- BEGIN SIDEBAR -->
<?php echo View::make('common/menu', ["code" => "admin"]); ?>
<!-- END SIDEBAR -->
                                    ...
                                    <div class="portlet-body">
                                        <div class="table">
                                            <table class="table table-bordered table-hover">
                                                <thead>
                                                <tr>
                                                    <th class="col-md-2"> 商家管理员名 </th>
                                                    <th class="col-md-1"> 角色名称 </th>
                                                    <th class="col-md-1"> 登陆账号 </th>
                                                    <th class="col-md-1"> 商家管理员手机号 </th>
                                                    <th class="col-md-1"> 商家管理员来源 </th>
