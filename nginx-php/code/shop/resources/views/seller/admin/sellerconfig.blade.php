...
<div class="page-container">
    <!-- BEGIN SIDEBAR -->
    <?php echo View::make('common/menu', ["code" => "sellerconfig"]); ?>
    <!-- END SIDEBAR -->
        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="/selleradmin/sellerconfig/<?php echo isset($model) ? $model->id : ""; ?>">商家配置</a>
                        <!--                        <i class="fa fa-angle-right"></i>-->
                    </li>
                    <li>
                ...
                <div class="col-md-12">
                    <div class="portlet light">
                        <div class="portlet-body form">
                            <form class="form-horizontal ajax-form" action="/selleradmin/sellerconfig/<?php echo isset($model) ? $model->config_id : ""; ?>" method="<?php echo isset($model) ? "put" : "post"; ?>">
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="config_item" value="<?php echo isset($model) ? $model->config_item : ""; ?>" class="form-control input-inline input-medium">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="config_value" value="<?php echo isset($model) ? $model->config_value : ""; ?>" class="form-control input-inline input-medium">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="form-control" rows="3" name=remark><?php echo isset($model) ? $model->remark : ""; ?></textarea>
                                        </div>
                                    </div>
...
<script>
    jQuery(document).ready(function () {
        $('body').on("success", ".ajax-form", function (result) {
            location.href = "/selleradmin/sellerconfiglist";
        });
