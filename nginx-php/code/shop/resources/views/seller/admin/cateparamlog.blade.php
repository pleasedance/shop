                        ...
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row dataTables_wrapper">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <a href="/selleradmin/productparam/<?php echo $param_number;?>">
                                            ...
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <?php foreach ($list as $value) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-circle" href="/selleradmin/productparam/<?php echo $param_number; ?>/<?php echo $value->param_number; ?>">
                                                                编辑
                                                            </a>
                                                            <a class="btn btn-circle" href="/selleradmin/productparampros/<?php echo $value->param_number; ?>">
                                                                参数属性列表
                                                            </a>
