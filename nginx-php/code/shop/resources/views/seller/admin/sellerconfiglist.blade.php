        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="/selleradmin/sellerconfiglist">商家配置列表</a>
                        <!--                        <i class="fa fa-angle-right"></i>-->
                    </li>
                    <li>
                    ...
                    <div class="portlet light portlet-fit ">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase">商家配置列表</span>
                            </div>
                        </div>
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row dataTables_wrapper">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <a href="/selleradmin/sellerconfig">
                                    ...
                                    <div class="portlet-body">
                                        <div class="table">
                                            <table class="table table-bordered table-hover">
                                                <thead>
                                                <tr>
                                                    <th class="col-md-2"> 配置项名称 </th>
                                                    <th class="col-md-1"> 配置项value </th>
                                                    <th class="col-md-1"> 排序设置 </th>
                                                ...
                                                <?php foreach ($list as $value) { ?>
                                                    <tr>
                                                        <td><?php echo $value->config_item; ?></td>
                                                        <td><?php echo $value->config_value; ?></td>
                                                        <td><?php echo $value->sort; ?></td>
                                                        <td><?php echo $value->remark; ?></td>
                                                        <td>
                                                            <a class="btn btn-circle" href="/selleradmin/sellerconfig/<?php echo $value->config_id; ?>">
                                                                编辑
                                                            </a>
                                                            <a class="btn btn-circle" href="javascript:;" onclick="del(<?php echo $value->config_id;?>)">
                                                                删除
                                                            </a>
                                                        </td>
                                                    </tr>
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            window.del = function(id) {
                $.ajax({
                    type: "post",
                    url: "/selleradmin/delSellerConfig",
                    data: {product_id:id},
                    dataType: "json",
