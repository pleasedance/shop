                                            ...
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <?php foreach ($list as $value) { ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-circle" href="/selleradmin/category/<?php echo $value->category_id; ?>">
                                                                编辑
                                                            </a>
                                                            <a class="btn btn-circle" href="/selleradmin/cateparamlog/<?php echo $value->category_id; ?>">
                                                                参数组列表
                                                            </a>
                                                            <a class="btn btn-circle" href="/selleradmin/categoryskulog/<?php echo $value->category_id; ?>">
                                                                分类sku列表
                                                            </a>
                                                            <a class="btn btn-circle" href="javascript:;" onclick="statusChange(<?php echo $value->category_id.','.($value->status?"0":"1");?>)">
                                                                <?php echo $value->status?"禁用":"启用"; ?>
                                                            </a>
                                                            <a class="btn btn-circle" href="javascript:;" onclick="del(<?php echo $value->category_id;?>)">
                                                                删除
                                                            </a>
                                                        </td>
                                                    </tr>
