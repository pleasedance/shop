...
<div class="page-container">
    <!-- BEGIN SIDEBAR -->
<?php echo View::make('common/menu', ["code" => "brand"]); ?>
<!-- END SIDEBAR -->
                ...
                <div class="col-md-12">
                    <div class="portlet light">
                        <div class="portlet-body form">
                            <form class="form-horizontal ajax-form" action="/selleradmin/brand/<?php echo isset($model)?$model->brand_id:"";?>" method="<?php echo isset($model) ? "put" : "post"; ?>" enctype="multipart/form-data">
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div><img id="logoImage" src="<?php echo isset($model)?"http://".\Request::server('HTTP_HOST').$model->brand_logo_url:"";?>"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <i class="fa fa-plus"></i>
                                            <div><img id="detailImage" src="<?php echo isset($model)?"http://".\Request::server('HTTP_HOST').$model->brand_detail_url:"";?>"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="radio" name="is_show" value="1" class="form-control input-inline" <?php echo (isset($model)&&$model->is_show) ? "checked" : "";?> >是
...
<script>
    jQuery(document).ready(function () {
        $('body').on("success", ".ajax-form", function (result) {
            location.href = "/selleradmin/brandlog";
        });
