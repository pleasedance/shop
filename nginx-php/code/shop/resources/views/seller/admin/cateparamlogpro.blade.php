                    ...
                    <div class="portlet light portlet-fit ">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase">商品参数属性列表</span>
                            </div>
                        </div>
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row dataTables_wrapper">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <a href="/selleradmin/productparampro/<?php echo $param_number;?>">
                                        ...
                                        <div class="table">
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <?php foreach ($list as $value) { ?>
                                                    <tr>
                                                        <td><?php echo $value->param_propertie_value; ?></td>
                                                        <td>
                                                            <a class="btn btn-circle" href="/selleradmin/productparampro/<?php echo $param_number; ?>/<?php echo $value->cpp_id; ?>">
                                                                编辑
                                                            </a>
                                                        </td>
                                                    </tr>
