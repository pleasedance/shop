                        ...
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row dataTables_wrapper">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <a href="/selleradmin/categoryskuproperties/<?php echo $sku_number;?>">
                                            ...
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <?php foreach ($list as $value) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-circle" href="/selleradmin/categoryskuproperties/<?php echo $sku_number; ?>/<?php echo $value->sp_id; ?>">
                                                                编辑
                                                            </a>
                                                        </td>
                                                    </tr>
