                                        ...
                                        <div class="portlet-body">
                                            <div class="table">
                                                <table class="table table-bordered table-hover">
                                                    <thead>
                                                    <tr>
                                                        <th class="col-md-2"> 系统管理员名 </th>
                                                        <th class="col-md-1"> 登录账号 </th>
                                                        <th class="col-md-1"> 邮箱地址 </th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="/companyadmin/user/<?php echo $value->sys_user_id;?>">编辑</a>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                                    </tbody>
