...
<div class="page-container">
    <!-- BEGIN SIDEBAR -->
<?php echo View::make('common/menu_company', ["code" => "amount/user/log"]); ?>
<!-- END SIDEBAR -->
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            <!-- BEGIN PAGE HEADER-->
            <h1 class="page-title"> 企业发放明细
            </h1>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    <li>
                        <i class="icon-home"></i>
                        <a href="/companyadmin">代币记录</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
                        <i class="icon-user"></i>
                        <a href="javascript:;">企业发放明细</a>
                    </li>
                    <li>
                    ...
                    <div class="portlet light portlet-fit ">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase">企业发放明细</span>
                            </div>
                        </div>
                                            ...
                                            <div class="table">
                                                <table class="table table-bordered table-hover">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th class="col-md-1"> 操作IP </th>
                                                        <th class="col-md-1"> 数额 </th>
                                                    ...
                                                    <tr>
                                                        <td><?php echo isset($value->buyer) ? $value->buyer->real_name : ""; ?></td>
