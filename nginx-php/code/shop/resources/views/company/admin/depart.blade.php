    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <h1 class="page-title"> 用户管理
                <small><?php echo isset($model) ? "修改" : "添加"; ?>部门</small>
            </h1>
            <div class="page-bar">
                ...
                <div class="col-md-12">
                    <div class="portlet light">
                        <div class="portlet-body form">
                            <form class="form-horizontal ajax-form" action="/companyadmin/depart/<?php echo isset($model) ? $model->depart_id : ""; ?>" method="<?php echo isset($model) ? "put" : "post"; ?>">
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="depart_name" value="<?php echo isset($model) ? $model->depart_name : ""; ?>" class="form-control input-inline input-medium">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">
                                        ...
                                        <div class="col-md-9">
                                            <select name="parent_id" class="form-control input-inline input-medium">
                                                <option value="0">未选择上级部门</option>
                                                <?php
                                                    $depart_list = json_decode(json_encode($depart),true);
                                                    function getSon($id,$array=array(),$level=1){
                                                        ...
                                                        foreach ($array as $k => $v) {
                                                            if( $v['parent_id'] == $id){
                                                                ...
                                                                echo "<option value='".$v['depart_id']."' ".((isset($v['parent_id'])&&($v['parent_id']==$v['depart_id']))?'selected':'').">".$v['depart_name']."</option>";
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="form-control" rows="3" name="depart_descr"><?php echo isset($model) ? $model->depart_descr : ""; ?></textarea>
                                        </div>
                                    </div>
