...
<!--[if !IE]><!--> <html lang="zh-CN" class="no-js"> <!--<![endif]-->
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid">
        ...
        <div class="page-container">
            <!-- BEGIN SIDEBAR -->
            <?php echo View::make('common/menu', ["code" => "order_money"]); ?>
            <!-- END SIDEBAR -->
                            ...
                            <div class="portlet light portlet-fit ">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">金额订单列表</span>
                                    </div>
                                </div>
                                            ...
                                            <div class="table">
                                                <ul class="nav nav-tabs">
                                                    <li<?php echo $status==App\Models\CompanyOrderModel::statusInit ? ' class="active"' :  '' ?>>
                                                        <a href="/order/money?status=<?php echo App\Models\CompanyOrderModel::statusInit ?>">待审核</a>
                                                    </li>
                                                    <li<?php echo $status==App\Models\CompanyOrderModel::statusSuccess ? ' class="active"' :  '' ?>>
                                                        <a href="/order/money?status=<?php echo App\Models\CompanyOrderModel::statusSuccess ?>">已通过</a>
                                                    </li>
                                                    <li<?php echo $status==App\Models\CompanyOrderModel::statusFail ? ' class="active"' :  '' ?>>
                                                        <a href="/order/money?status=<?php echo App\Models\CompanyOrderModel::statusFail; ?>">已拒绝</a>
                                                    </li>
                                                </ul>
                                                        ...
                                                        <?php foreach ($list as $value) { ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a class="ajax" confirm="确定要通过该充值订单？" method="post" href="/order/money/status?id=<?php echo $value->id; ?>">
                                                                        通过
                                                                    </a>
                        ...
                        bootbox.dialog({
                            ...
                            buttons: {
                              success: {
                                ...
                                className: "green",
                                callback: function() {
                                    ajaxHttp("/order/money/status","delete",{id:id,reason:$("input[name=reason]").val()},function(){
                                        swal({
                                            title: "成功",
                                            text: "执行完成",
                                            type: "success",
