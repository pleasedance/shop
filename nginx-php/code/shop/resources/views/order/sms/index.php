...
<!--[if !IE]><!--> <html lang="zh-CN" class="no-js"> <!--<![endif]-->
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid">
        ...
        <div class="page-container">
            <!-- BEGIN SIDEBAR -->
            <?php echo View::make('common/menu', ["code" => "order_sms"]); ?>
            <!-- END SIDEBAR -->
                            ...
                            <div class="portlet light portlet-fit ">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">短信订单列表</span>
                                    </div>
                                </div>
                                            ...
                                            <div class="table">
                                                <ul class="nav nav-tabs">
                                                    <li<?php echo $status==App\Models\CompanyOrderModel::statusInit ? ' class="active"' :  '' ?>>
                                                        <a href="/order/sms?status=<?php echo App\Models\CompanyOrderModel::statusInit ?>">待审核</a>
                                                    </li>
                                                    <li<?php echo $status==App\Models\CompanyOrderModel::statusSuccess ? ' class="active"' :  '' ?>>
                                                        <a href="/order/sms?status=<?php echo App\Models\CompanyOrderModel::statusSuccess ?>">已通过</a>
                                                    </li>
                                                    <li<?php echo $status==App\Models\CompanyOrderModel::statusFail ? ' class="active"' :  '' ?>>
                                                        <a href="/order/sms?status=<?php echo App\Models\CompanyOrderModel::statusFail; ?>">已拒绝</a>
                                                    </li>
                                                </ul>
            ...
            '</div></div></div>'
                        ...
                        bootbox.dialog({
                            ...
                            buttons: {
                              success: {
                                ...
                                className: "green",
                                callback: function() {
                                    ajaxHttp("/order/sms/status","delete",{id:id,reason:$("input[name=reason]").val()},function(){
                                        swal({
                                            title: "成功",
                                            text: "执行完成",
                                            type: "success",
                    ...
                    $("body").on("click",".success",function(){
                        var id=$(this).attr("data-id");
                        var html='<div class="row"><div class="form-body"><div class="form-group">'+
                '<label class="col-md-3 control-label">兑换短信数量<span class="required" aria-required="true"> * </span></label>'+
                        ...
                        bootbox.dialog({
                            ...
                            buttons: {
                              success: {
                                ...
                                className: "green",
                                callback: function() {
                                    ajaxHttp("/order/sms/status","post",{id:id,num:$("input[name=num]").val()},function(){
                                        swal({
                                            title: "成功",
                                            text: "执行完成",
                                            type: "success",
