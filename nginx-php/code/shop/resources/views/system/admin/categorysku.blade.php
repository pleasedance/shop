    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <h1 class="page-title"> 分类管理
                <small><?php echo isset($model) ? "修改" : "添加"; ?>分类sku</small>
            </h1>
            <div class="page-bar">
                ...
                <div class="col-md-12">
                    <div class="portlet light">
                        <div class="portlet-body form">
                            <form class="form-horizontal ajax-form" action="/system/admin/categorysku/<?php echo $category_id; ?>/<?php echo isset($model) ? $model->sku_number : ""; ?>" method="<?php echo isset($model) ? "put" : "post"; ?>">
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="propertie_name" value="<?php echo isset($model) ? $model->propertie_name : ""; ?>" class="form-control input-inline input-medium">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">
                                        ...
                                        <div class="col-md-9">
                                            <input type="radio" name="is_search" value="1" class="form-control input-inline" <?php echo (isset($model)&&$model->is_search) ? "checked" : "";?> >是
                                            <input type="radio" name="is_search" value="0" class="form-control input-inline" <?php echo (isset($model)&&!$model->is_search) ? "checked" : "";?> >否
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">
                                        ...
                                        <div class="col-md-9">
                                            <input type="radio" name="is_mult_choose" value="1" class="form-control input-inline" <?php echo (isset($model)&&$model->is_mult_choose) ? "checked" : "";?> >是
                                            <input type="radio" name="is_mult_choose" value="0" class="form-control input-inline" <?php echo (isset($model)&&!$model->is_mult_choose) ? "checked" : "";?> >否
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">
...
<script>
    jQuery(document).ready(function () {
        $('body').on("success", ".ajax-form", function (result) {
            location.href = "/system/admin/categoryskulog/<?php echo $category_id; ?>";
        });
