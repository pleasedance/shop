    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <h1 class="page-title"> 分类管理
                <small><?php echo isset($model) ? "修改" : "添加"; ?>分类参数属性</small>
            </h1>
            <div class="page-bar">
                ...
                <div class="col-md-12">
                    <div class="portlet light">
                        <div class="portlet-body form">
                            <form class="form-horizontal ajax-form" action="/system/admin/categoryparampro/<?php echo $param_id; ?>/<?php echo isset($model) ? $model->cpp_id : ""; ?>" method="<?php echo isset($model) ? "put" : "post"; ?>">
                                <div class="form-body">
...
<script>
    jQuery(document).ready(function () {
        $('body').on("success", ".ajax-form", function (result) {
            location.href = "/system/admin/cateparamprolog/<?php echo $param_id; ?>";
        });
