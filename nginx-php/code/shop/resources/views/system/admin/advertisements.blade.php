                    ...
                    <div class="portlet light portlet-fit ">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase">广告列表</span>
                            </div>
                        </div>
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row dataTables_wrapper">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <a href="/system/admin/advertisement">
                                        ...
                                        <div class="table">
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="col-md-2"> 是否上线 </th>
                                                    <th class="col-md-2"> 是否小程序链接 </th>
                                                    <th class="col-md-2"> 点击次数 </th>
                                                    <th class="col-md-2"> 广告链接 </th>
                                                    <th class="col-md-2"> 广告备注 </th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $value->start_status?"上线":"下线"; ?></td>
                                                    <td><?php echo $value->type?"否":"是"; ?></td>
                                                    <td><?php echo $value->click_count; ?></td>
                                                    <td><?php echo $value->ad_url; ?></td>
                                                    <td><?php echo $value->remarks; ?></td>
                                                    <td><?php echo $value->created_at; ?></td>
                                                    <td>
                                                        <a class="btn btn-circle" href="/system/admin/advertisement/<?php echo $value->ad_id; ?>">
                                                            编辑
                                                        </a>
                                                        <!--<a class="btn btn-circle" href="javascript:;" onclick="statusChange(<?php echo $value->ad_id.','.($value->start_status?"0":"1");?>)">
                                                            <?php //echo $value->start_status?"上线":"下线"; ?>
                                                        </a>-->
                                                        <a class="btn btn-circle" href="javascript:;" onclick="del(<?php echo $value->ad_id;?>)">
                                                            删除
                                                        </a>
                                                    </td>
                                                </tr>
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            window.statusChange = function(id,todo) {
                $.ajax({
                    type: "PUT",
                    url: "/system/admin/advertisementstat",
            ...
            window.del = function(id) {
                $.ajax({
                    type: "PUT",
                    url: "/system/admin/advertisementdel",
                    data: {id:id},
                    dataType: "json",
                    success: function(data){
                        // swal({
