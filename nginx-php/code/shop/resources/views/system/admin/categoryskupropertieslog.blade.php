                        ...
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row dataTables_wrapper">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <a href="/system/admin/categoryskuproperties/<?php echo $sku_number;?>">
                                        ...
                                        <div class="table">
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <?php foreach ($list as $value) { ?>
                                                    <tr>
                                                        <td><?php echo $value->sku_propertie_value; ?></td>
                                                        <td>
                                                            <a class="btn btn-circle" href="/system/admin/categoryskuproperties/<?php echo $sku_number; ?>/<?php echo $value->sp_id; ?>">
                                                                编辑
                                                            </a>
                                                        </td>
                                                    </tr>
