...
<div class="page-container">
    <!-- BEGIN SIDEBAR -->
<?php echo View::make('common/menu_user_system', ["code" => "admin"]); ?>
<!-- END SIDEBAR -->
                                    ...
                                    <div class="portlet-body">
                                        <div class="table">
                                            <table class="table table-bordered table-hover">
                                                <thead>
                                                <tr>
                                                    <th class="col-md-2"> 系统管理员账号 </th>
                                                    <th class="col-md-1"> 是否启用 </th>
                                                    <th class="col-md-1"> 系统管理员创建时间 </th>
                                                    <th class="col-md-1"> 系统管理员最近修改信息时间 </th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/system/admin/user/<?php echo $value->id;?>">编辑</a>
                                                        <a class="btn btn-circle" href="javascript:;" onclick="statusChange(<?php echo $value->id.','.($value->status?"0":"1");?>)">
