                    ...
                    <div class="portlet light portlet-fit ">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase">分类sku列表</span>
                            </div>
                        </div>
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row dataTables_wrapper">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <a href="/system/admin/categorysku/<?php echo $category_id;?>">
                                        ...
                                        <div class="table">
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <?php foreach ($list as $value) { ?>
                                                    <tr>
                                                        <td><?php echo $value->propertie_name; ?></td>
                                                        <td><?php echo $value->status?"启用":"禁用"; ?></td>
                                                        <td><?php echo $value->sort; ?></td>
                                                        <td>
                                                            <a class="btn btn-circle" href="/system/admin/categorysku/<?php echo $category_id; ?>/<?php echo $value->sku_number; ?>">
                                                                编辑
                                                            </a>
                                                            <a class="btn btn-circle" href="/system/admin/categoryskupropertieslog/<?php echo $value->sku_number; ?>">
                                                                分类sku值列表
                                                            </a>
                                                            <a class="btn btn-circle" href="javascript:;" onclick="statusChange(<?php echo $value->propertie_id.','.($value->status?"0":"1");?>)">
                                                                <?php echo $value->status?"禁用":"启用"; ?>
                                                            </a>
                                                            <a class="btn btn-circle" href="javascript:;" onclick="del(<?php echo $value->propertie_id;?>)">
                                                                删除
                                                            </a>
                                                        </td>
                                                    </tr>
