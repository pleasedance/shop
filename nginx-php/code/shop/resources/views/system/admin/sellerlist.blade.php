                    ...
                    <div class="portlet light portlet-fit ">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase">商家列表</span>
                            </div>
                        </div>
                                            ...
                                            <div class="table">
                                                <table class="table table-bordered table-hover">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="javascript:;" onclick="statusChange(<?php echo $value->seller_id.','.($value->status?"0":"1");?>)"><?php echo $value->status?"禁用":"启用"; ?></a>
                                                            <a class="btn btn-circle" href="/system/admin/seller/<?php echo $value->seller_id; ?>">
                                                                编辑
                                                            </a>
                                                        </td>
                                                    </tr>
