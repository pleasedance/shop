...
<div class="page-container">
    <!-- BEGIN SIDEBAR -->
<?php echo View::make('common/menu_user_system', ["code" => "users"]); ?>
<!-- END SIDEBAR -->
                ...
                <div class="col-md-12">
                    <div class="portlet light">
                        <div class="portlet-body form">
                            <form class="form-horizontal ajax-form" action="/system/admin/user/<?php echo isset($model) ? $model->id : ""; ?>" method="<?php echo isset($model) ? "put" : "post"; ?>">
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="password" name="password" value="" class="form-control input-inline input-medium">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">
                                    ...
                                    <input type="hidden" name="system_id" value="<?php echo isset($user) ? $user->id : 0; ?>" >
                                </div>
...
<script>
    jQuery(document).ready(function () {
        ...
        $('form').submit(function(){
            if( $("input[name='loginid']").val() == false ){
                alert.msg('请输入账号！',{'position':'center','background':'#32c5d2'});
                return false;
            }
