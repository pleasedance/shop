    ...
    <div class="row bs-reset">
        ...
        <div class="col-md-6 login-container bs-reset">
            <div class="login-content" style="margin-top: 25%">
                <h1>总后台管理 登录界面</h1>
                <p> 当前版本v1.0.0 </p>
                <form action="/system" class="form-horizontal ajax-form" method="post">
                    <div class="form-group col-md-12">
                        <div class="col-md-6">
                            <input class="form-control" type="text" autocomplete="off" placeholder="账号" name="loginid" required/>
                        </div>
                        <!--                            <div class="col-md-6">-->
