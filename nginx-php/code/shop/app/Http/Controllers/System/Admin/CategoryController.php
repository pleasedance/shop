...
class CategoryController extends BaseController
{
    ...
    public function getCategory($id = 0){
        ...
        $res['brand'] = \App\Models\BrandModel::where("del_status",\App\Models\BrandModel::delInactive)
            ->get();
        if ($id){
            $model = \App\Models\CategoryModel::where("category_id",$id)
                ->first();
            $res['model'] = $model;
            $res['p_category'] = \App\Models\CategoryModel::where("category_id","<>",$id)->where('del_status','=',0)->where("status",'=',1)
                ->get();
        }else{
            $res['p_category'] = \App\Models\CategoryModel::where('del_status','=',0)->where("status",'=',1)->get();
        }

        return \View::make("system/admin/category",$res);
    }
    ...
    public function postCategory()
    {
        ...
        $brandId = \Jinput::get("brand_id");
        if(!$brandId){
            throw new \App\Exceptions\AppException("请选择品牌");
        }
        $brandModel = \App\Models\BrandModel::where("brand_id",$brandId)->first();
...
//        $server->setUnit($unit);
    ...
    public function getCatalog(){
        ...
        $model = \App\Models\CategoryModel::where("del_status",\App\Models\CategoryModel::delInactive)
            ...
            ->paginate(50);
        $res['list'] = $model;
        return \View::make("system/admin/catalog",$res);
    }
    ...
    public function getCategoryParam($cid = 0,$paramNumber = ""){
        ...
        return \View::make("system/admin/categoryparam",$res);
    }
    ...
    public function getCateParamLog($cid){
        ...
        $res['list'] = $model;
        $res['category_id'] = $cid;
        return \View::make("system/admin/cateparamlog",$res);
    }
    ...
    public function getCategoryParamPro($cid = 0,$id = 0){
        ...
        return \View::make("system/admin/categoryparampro",$res);
    }
     ...
     * 分类参数属性修改
     */
    public function putCategoryParamPro($paramNumber = 0,$id = 0)
    {
        $paramPropertieValue = \Jinput::get("param_propertie_value");
        if(!$paramPropertieValue){
            throw new \App\Exceptions\AppException("请填写参数值");
    ...
    public function getCateParamLogPro($paramNumber){
        ...
        return \View::make("system/admin/cateparamlogpro",$res);
    }
    ...
    public function getCategorySku($cid = 0,$skuNumber = ""){
        ...
        return \View::make("system/admin/categorysku",$res);
    }
    ...
    public function getCategorySkuLog($id){
        ...
        $res['list'] = $model;
        $res['category_id'] = $id;
        return \View::make("system/admin/categoryskulog",$res);
    }
    ...
    public function getCategorySkuProperties($cid = 0,$id = 0){
        ...
        return \View::make("system/admin/categoryskuproperties",$res);
    }
    ...
    public function getCategorySkuPropertiesLog($skuNumber){
        ...
        return \View::make("system/admin/categoryskupropertieslog",$res);
    }
