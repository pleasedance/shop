...
class OrderSubModel extends BaseModel
{
    protected $table = "order_sub";
    protected $primaryKey = 'order_sub_sn';
...
//    const onlinePay = 2;//网银
    ...
    public function orderDetail(){
        return $this->hasOne("App\Models\OrderDetailModel","order_sub_sn","order_sub_sn");
    }

    public function orderReturns(){
        return $this->hasOne("App\Models\OrderReturnsModel","order_sub_sn","order_sub_sn");
    }
