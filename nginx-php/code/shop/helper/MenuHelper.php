...
class MenuHelper {
    ...
    public static function get(App\Models\SellerUserModel $SellerUserModel){
...
//        return $menus;
        ...
        foreach ($menu as $value){
            ...
            if($permission === FALSE){
                if($SellerUserModel->role_name == App\Models\SellerUserModel::roleRoot){
                    $menus[] = $value;
                }
            }elseif($permission){
                if(PermissionHelper::can($SellerUserModel, $value['permission'])){
                    $menus[] = $value;
                }
            }else{
                $menus[] = $value;
